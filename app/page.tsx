...
export default function LeadCapture() {
  ...
  const [activeTab, setActiveTab] = useState<'how' | 'tech' | null>(null)
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="flex justify-center gap-6 text-sm mb-10">
          <Link href="/dashboard" className="text-gray-500 hover:text-gray-300 transition-colors">View dashboard →</Link>
          <button onClick={() => setActiveTab(activeTab === 'how' ? null : 'how')}
            className={`transition-colors ${activeTab === 'how' ? 'text-blue-400' : 'text-gray-500 hover:text-gray-300'}`}>
            How it works {activeTab === 'how' ? '↑' : '↓'}
          </button>
          <button onClick={() => setActiveTab(activeTab === 'tech' ? null : 'tech')}
            className={`transition-colors ${activeTab === 'tech' ? 'text-purple-400' : 'text-gray-500 hover:text-gray-300'}`}>
            Tech stack {activeTab === 'tech' ? '↑' : '↓'}
          </button>
        </div>
